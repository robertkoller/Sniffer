    ...
    <div className="min-h-screen bg-[#FFFDF9] relative overflow-x-hidden">
      ...
      <nav className="relative z-10 px-6 py-6 flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex items-center gap-8 text-amber-900/60 font-medium text-sm">
          <a href="#" className="hover:text-amber-900 transition-colors">How it works</a>
          <a href="#" className="hover:text-amber-900 transition-colors">Trusted Sellers</a>
          <a href="#" className="px-5 py-2 bg-amber-50 text-amber-900 rounded-full hover:bg-amber-100 transition-colors">Sign In</a>
        </div>
      </nav>
      ...
      <main className="relative z-10 pt-12">
        {!results ? (
          <div className="text-center px-4 animate-in fade-in duration-1000">
            {/* AI-Powered Scent Discovery part commented out as requested */}
            {/* 
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-amber-50 rounded-full text-amber-700 text-xs font-bold uppercase tracking-widest mb-6">
          ...
          <div className="flex gap-12">
            <div className="space-y-4">
              ...
              <ul className="text-amber-900/60 text-sm space-y-2">
                <li><a href="#" className="hover:text-amber-900 transition-colors">Price Match</a></li>
                <li><a href="#" className="hover:text-amber-900 transition-colors">Seller API</a></li>
                <li><a href="#" className="hover:text-amber-900 transition-colors">Store Locator</a></li>
              </ul>
            </div>
            <div className="space-y-4">
              ...
              <ul className="text-amber-900/60 text-sm space-y-2">
                ...
                <li><a href="#" className="hover:text-amber-900 transition-colors">Terms of Use</a></li>
                <li><a href="#" className="hover:text-amber-900 transition-colors">Trust Center</a></li>
              </ul>
            </div>
          </div>
        </div>
